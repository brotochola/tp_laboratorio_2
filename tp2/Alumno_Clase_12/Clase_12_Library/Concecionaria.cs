            ...
            foreach (Vehiculo v in concecionaria._vehiculos)
            {
                ...
                switch (tipoDeVehiculo)
                {
                    case ETipo.Automovil:
                        if(v.CantidadRuedas == 4) sb.AppendLine(v.MostrarPublico);
                        break;
                    case ETipo.Moto:
                        if (v.CantidadRuedas == 2) sb.AppendLine(v.MostrarPublico);
                        break;
                    case ETipo.Camion:
                        if (v.CantidadRuedas == 8) sb.AppendLine(v.MostrarPublico);
                        break;
                    default:
                        sb.AppendLine(v.MostrarPublico);
                        break;
                }
            }
